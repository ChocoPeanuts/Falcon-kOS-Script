//Falcon kOS Script Falcon Heavy Landing Ver 2.1
...
else if LZ["Type"] = 2
{
    ...
    until false
    {
        print ship:geoposition:lat at (0, 0).
        print ship:geoposition:lng at (0, 1).
        print impactData()["LatLng"]:lat at (0, 3).
        print impactData()["LatLng"]:lng at (0, 4).
    }
}

wait until ship:verticalspeed < -600 and ThrottleControl(ship:maxthrust, 30000, -550) > 1.
