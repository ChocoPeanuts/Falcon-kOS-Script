//Falcon kOS Script Falcon Heavy Library Ver 2.0
...
function TrueAlt
{
    parameter offset, minValue to "false".

    local Result to alt:radar - offset.
...
function ThrottleControl
{
    ...
    return (StopDist + tgAlt) / TrueAlt(radarOffset, 0.001).
}
